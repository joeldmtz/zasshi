...
class Index extends Controller
{
    ...
    {
        $data['section_aboutus'] = SectionAbout::where('status',1)->get();
        $data['section_gallery'] = SectionGalery::where('status',1)->get();
        $data['section_testimonials'] = SectionTestimonials::where('status',1)->get();
        $data['section_schedule'] = ContactSchedule::where('status',1)->get();
        $data['section_contact'] = SectionContact::where('status',1)->get();
